...
class Music():
    ...
    def music_player_connected(song: wavelink.YouTubeTrack, ctx: commands.Context):
        if language == "ru":
            embed = discord.Embed(
                color=0xebd8c3,
                title=f"{song.title}",
        ...
        if language == "ru":
            ...
            if is_self is False:
                embed = discord.Embed(
                    color=0xebd8c3,
                    title="Player paused",
                    description=f"User **{r.user.name}** paused playing track."
                )
            else:
                embed = discord.Embed(
                    color=0xebd8c3,
        ...
        if language == "ru":
            ...
            if is_self is False:
                embed = discord.Embed(
                    color=0xebd8c3,
                    title="Player paused",
                    description=f"User **{ctx.author.name}** paused playing track."
                )
            else:
                embed = discord.Embed(
                    color=0xebd8c3,
        ...
        if language == "ru":
            ...
            if is_self is False:
                embed = discord.Embed(
                    ...
                    description=f"User **{r.user.name}** resumed playing track."
                )
            else:
                embed = discord.Embed(
                    color=0xebd8c3,
        ...
        if language == "ru":
            ...
            if is_self is False:
                embed = discord.Embed(
                    color=0xebd8c3,
                    title="Player resumed",
                    description=f"User **{ctx.author.name}** resumed playing track."
                )
            else:
                embed = discord.Embed(
                    color=0xebd8c3,
        ...
        if language == "ru":
            ...
            if is_self is False:
                embed = discord.Embed(
                    color=0xebd8c3,
                    title="Loop enabled",
                    description=f"User **{r.user.name}** enabled track loop."
                )
            else:
                embed = discord.Embed(
                    color=0xebd8c3,
        ...
        if language == "ru":
            ...
            if is_self is False:
                embed = discord.Embed(
                    color=0xebd8c3,
                    title="Loop disabled",
                    description=f"User **{r.user.name}** disabled track loop."
                )
            else:
                embed = discord.Embed(
                    color=0xebd8c3,
    ...
    def track_added(r: discord.Interaction, song: wavelink.YouTubeTrack):
        if language == "ru":
            embed = discord.Embed(
                color=0xebd8c3,
                title=song.title,
    ...
    def track_added_ctx(ctx: commands.Context, song: wavelink.YouTubeTrack):
        if language == "ru":
            embed = discord.Embed(
                color=0xebd8c3,
                title=song.title,
    ...
    def track_added_to_play(r: discord.Interaction, song: wavelink.YouTubeTrack):
        if language == "ru":
            embed = discord.Embed(
                color=0xebd8c3,
                title=song.title,
    ...
    def self_track_added(r: discord.Interaction, song: wavelink.YouTubeTrack):
        if language == "ru":
            embed = discord.Embed(
                color=0xebd8c3,
                title=song.title,
    ...
    def self_track_added_to_play(r: discord.Interaction, song: wavelink.YouTubeTrack):
        if language == "ru":
            embed = discord.Embed(
                color=0xebd8c3,
                title=song.title,
    ...
    def stopped(r: discord.Interaction):
        if language == "ru":
            ...
            embed = discord.Embed(
                ...
                description=f"**{r.user.name}** destroyed music player. Music playback is stopped, the bot was disconnected from the voice channel."
            )
        return embed
    ...
    def ctx_stopped(ctx: commands.Context):
        if language == "ru":
            ...
            embed = discord.Embed(
                color=0xdd5f65,
                title="Player Destroyed",
                description=f"**{ctx.author.name}** destroyed music player. Music playback is stopped, the bot was disconnected from the voice channel."
            )
        return embed
